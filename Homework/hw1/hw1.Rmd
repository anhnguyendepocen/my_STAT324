...
Using the hepatisis A data (`hepA.csv`) from Canvas, answer the following questions:
...
**Question 6:** the large-scale use of the hepatitis A vaccine started in 1995. Add a vertical line to your plot at the year 1995.